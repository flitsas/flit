...
describe("agrupación de tipos de trámite", () => {
  const types: ProcedureTypeSummary[] = [
    { id: "1", code: "TRA", name: "Traspaso simple", family: "TRASPASO", publicationStatus: "published", isActive: true, wizardEnabled: true, publishedAt: null, description: null },
    { id: "2", code: "MAT", name: "Matrícula inicial", family: "MATRICULAS", publicationStatus: "published", isActive: true, wizardEnabled: true, publishedAt: null, description: null },
    { id: "3", code: "OTR", name: "Otro trámite", family: "OTROS", publicationStatus: "published", isActive: true, wizardEnabled: true, publishedAt: null, description: null },
  ];
