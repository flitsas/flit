 ...
 * `AAA12A` o antigua `AAA12`, remolque/semirremolque `R12345`/`S12345` y
 * maquinaria (agrícola/industrial/construcción) `AA123456` (2 letras + 6 dígitos,
 * p. ej. `MC029554`). La placa la valida en definitiva el RUNT; este patrón es un
 * chequeo anti-error de tipeo.
 */
export const PLATE_PATTERN = /^([A-Z]{3}[0-9]{3}|[A-Z]{3}[0-9]{2}[A-Z]?|[RS][0-9]{5}|[A-Z]{2}[0-9]{6})$/;
