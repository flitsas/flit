...
/**
 * Layout de /admin/quipux/*. Copia exacta del patrón de /admin/transit-offices,
 * /admin/companies e /admin/improntas: replica el chrome de la SPA (auth real por JWT +
 * Shell con dock) para que el dock NO desaparezca al entrar al submódulo "Integración
 * Quipux". El dock navega de vuelta a la SPA (/?m=…) o a /tramites; el botón "Quipux" del
 * dock queda resaltado por la ruta. Solo SuperAdmin (el middleware ya restringe /admin/*).
 */
export default function AdminQuipuxLayout({ children }: { children: ReactNode }) {
