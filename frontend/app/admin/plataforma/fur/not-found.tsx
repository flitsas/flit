...
/**
 * 404 del segmento `/admin/plataforma/fur` (Plataforma → FUR).
 */
export default function AdminFurNotFound() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col px-4 py-10 md:px-6">
      <div
        role="status"
        aria-live="polite"
        data-testid="admin-fur-not-found"
      ...
      >
        ...
        <p className="max-w-md text-sm text-[#59677D] dark:text-white/55">
          Esta sección del simulador FUR no está disponible. Vuelve al inicio o elige otra opción del
          menú Plataforma.
        </p>
        <span className="sr-only">
          404. FUR no disponible. Esta sección del simulador FUR no está disponible.
        </span>
        <Link
          href="/"
