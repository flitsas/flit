            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Admin.ImprontaGenerationEntity", b =>
                {
                    ...
                    b.ToTable("impronta_generations", "admin", t =>
                        {
                            t.HasCheckConstraint("ck_impronta_generations_identificador_vehiculo", "num_motor IS NOT NULL OR num_chasis IS NOT NULL OR num_serie IS NOT NULL");
                        });
                });
