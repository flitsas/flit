 ...
 * Carga/guarda vía useProcedureActors. Pensado para extraerse al step del
 * wizard en el Slice 4.
 */
export function ActorsForm({ instanceId, modalidad, roles: rolesProp, onSaved }: Props) {
  const roles = useMemo(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const normalized = actors.map((a) => ({
      ...a,
      telefono: a.telefono?.trim() ? a.telefono.trim() : undefined,
    }));
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateActor(index, {
                        tipoDocumento: e.target.value as ActorDocumentType,
                      })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateActor(index, { numeroDocumento: e.target.value })
                    }
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateActor(index, { nombreCompleto: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-describedby={
                      errors.email ? `${prefix}-email-err` : undefined
                    }
                    className={INPUT_BASE}
                    style={{ borderColor: '#DFE5ED' }}
                  />
