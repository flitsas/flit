    ...
    <main className="min-h-screen flex">
      ...
      <div className="w-full md:w-5/12 bg-white flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-10">
        ...
        <div
          ...
          style={{ background: "linear-gradient(135deg,var(--color-flit-brand),var(--color-flit-tech))" }}
        >
          <BrandLogo brand={brand} variant="white" alt={platformName} className="h-7 w-auto" />
        </div>

        {/* Key icon */}
        <div className="w-12 h-12 rounded-2xl mb-6 hidden md:flex items-center justify-center" style={{ background: "var(--color-flit-tech)" }}>
          <svg viewBox="0 0 24 24" fill="none" className="h-6 w-6" stroke="white" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
          </svg>
        </div>

        <h1 className="text-2xl font-bold mb-1" style={{ color: "var(--color-flit-primary)" }}>Activa tu cuenta</h1>
        <p className="text-sm mb-8 opacity-60" style={{ color: "var(--color-flit-primary)" }}>
