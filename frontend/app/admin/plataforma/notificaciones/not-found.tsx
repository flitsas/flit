...
/**
 * 404 del segmento `/admin/plataforma/notificaciones` (Plataforma → Notificaciones).
 * Patrón AlertCard / OtUnderConstructionState: tarjeta blanca dentro del Shell.
 * La pantalla real (HU #11370) aún no existe; este 404 evita que la ruta reviente
 * mientras tanto.
 */
export default function AdminNotificacionesNotFound() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col px-4 py-10 md:px-6">
      <div
        role="status"
        aria-live="polite"
        data-testid="admin-notificaciones-not-found"
      ...
      >
        ...
        <p className="max-w-md text-sm text-[#59677D] dark:text-white/65">
          Esta sección de notificaciones aún no está construida. Vuelve al inicio o elige otra
          opción del menú Plataforma.
        </p>
        <span className="sr-only">
          404. Notificaciones no disponible. Esta sección de notificaciones aún no está
          construida.
        </span>
        <Link
          href="/"
