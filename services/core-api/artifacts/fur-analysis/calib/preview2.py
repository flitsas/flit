import fitz, json
NEW_PDF="artifacts/fur-analysis/calib/out/p1-clean.pdf"
man=json.load(open("artifacts/fur-analysis/calib/manifest-792b.json",encoding="utf-8"))
...
out="artifacts/fur-analysis/calib/preview-clean-automotor-p1.png"
