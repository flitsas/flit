...
///
/// <para><see cref="StructuralErrorCode"/> es el único error que detecta HU #12522 (reglas de
/// porcentaje de propiedad y datos de contacto obligatorios de cada actor). Una fila con error estructural NO cancela el
