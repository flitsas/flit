...
'Perfil de conformación dinámico del tipo de trámite. Esquema: { entryMode: "PLATE"|"VIN"|"BOTH", requiresSeller: bool, requiresBuyer: bool, requiresCommercialValue: bool, commercialValueSource: "FASECOLDA"|"BASE_GRAVABLE"|"MERCADO_LIBRE"|null, requiresBiometrics: bool, biometricActors: string[], requiresSignature: bool, requiresPlateRequest: bool, validateCompanyRule: bool, validateOtOperability: bool, validateDuplicateProcedure: bool, validateSoat: bool, validatePazSalvoImpuesto: bool, hasPrendaGate: bool, simitMode: "INTERNAL"|"ONLINE"|null }. La multiplicidad de actores NO va aquí: es por-actor en conformation_rules.validation_profile.allowsMultiple (genérico OWNER/BUYER/LESSEE, cualquier tipo). Evaluado por DynamicGateEvaluator.cs cuando F08_DynamicProcedures flag = true.';
