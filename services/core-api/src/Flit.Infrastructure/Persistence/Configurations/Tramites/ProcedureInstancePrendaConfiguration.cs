...
internal sealed class ProcedureInstancePrendaConfiguration : IEntityTypeConfiguration<ProcedureInstancePrenda>
{
    ...
    {
        // DDL gestionado por migración SQL cruda (24-HU10585-prenda.sql + 103-prenda-accion-familia-dual.sql,
        // ADR-0055): índice único parcial (hasta dos vigentes por instancia, una por accion_familia,
        // nunca dos de la misma), CHECKs, RLS y triggers que el MigrationBuilder no modela.
        ...
        // ADR-0055 (HU #12128): familia de acción derivada de Decision (constitucion|levantamiento);
        // NULL en omitir/sin_prenda. DDL: 103-prenda-accion-familia-dual.sql.
        builder.Property(x => x.AccionFamilia)
            .HasColumnName("accion_familia").HasMaxLength(20);
