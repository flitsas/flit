...
namespace Flit.Infrastructure.Migrations
{
    ...
    [Migration("20260730022248_F11076_ReportingV2")]
    partial class F11076_ReportingV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Analytics.DashboardPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_dashboard_preferences");
                    ...
                    b.ToTable("dashboard_preferences", "analytics", t =>
                        {
            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Analytics.ExportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("export_jobs", "analytics", t =>
                        {
            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Analytics.HolidayCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "CountryCode", "HolidayDate")
                        .HasDatabaseName("ix_holiday_calendar_tenant_country_date")
                        .HasFilter("is_active = true");

                    b.ToTable("holiday_calendar", "analytics");
                });
            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Analytics.ReportSlaConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_report_sla_config");

                    b.HasIndex("TransitOfficeId")
                        .HasDatabaseName("ix_report_sla_config_transit_office_id");

                    b.HasIndex("TenantId", "ProcedureType", "TransitOfficeId")
                        .HasDatabaseName("ix_report_sla_config_tenant_lookup");

                    b.ToTable("report_sla_config", "analytics", t =>
                        {
            ...
            modelBuilder.Entity("Flit.Infrastructure.Persistence.Entities.Analytics.SavedQuery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("saved_queries", "analytics", t =>
                        {
            ...
            modelBuilder.Entity("Flit.Tramites.Domain.Entities.ProcedureInstanceStatusHistory", b =>
                {
                    ...
                    b.Property<Guid?>("OrganizationIdAtTime")
                        .HasColumnType("uuid")
                        .HasColumnName("organization_id_at_time");

                    b.Property<string>("OrganizationTypeAtTime")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<Guid?>("RoleIdAtTime")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id_at_time");
